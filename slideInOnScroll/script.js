// a function captured from the wild internet.
// to reduce how often functions run on scroll, for performance reasons
function debounce(func, wait = 20, immediate = true) {
  ...
  // a function that will run everytime the user scrolls
